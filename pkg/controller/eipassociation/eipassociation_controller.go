...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileEIPAssociation{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by EIPAssociation - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &eccv1alpha1.EIPAssociation{},
	})
	if err != nil {
		return err
	}
