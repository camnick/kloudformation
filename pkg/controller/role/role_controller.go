...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by Role - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &iamv1alpha1.Role{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=iam.aws.gotopple.com,resources=roles,verbs=get;list;watch;create;update;patch;delete
