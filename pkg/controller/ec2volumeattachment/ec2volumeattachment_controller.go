...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileEC2VolumeAttachment{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by EC2VolumeAttachment - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &eccv1alpha1.EC2VolumeAttachment{},
	})
	if err != nil {
		return err
	}
