...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileAddRoleToInstanceProfile{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by AddRoleToInstanceProfile - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &iamv1alpha1.AddRoleToInstanceProfile{},
	})
	if err != nil {
		return err
	}
