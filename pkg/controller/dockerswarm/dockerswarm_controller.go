...
// USER ACTION REQUIRED: update cmd/manager/main.go to call this swarm.Add(mgr) to install this Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileDockerSwarm{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &swarmv1alpha1.DockerSwarm{},
	})
	if err != nil {
		return err
	}
